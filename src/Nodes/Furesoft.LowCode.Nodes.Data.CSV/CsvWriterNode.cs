...
public class CsvWriterNode : DataTableNode
{
    ...
    [DataMember(EmitDefaultValue = false)] public CsvDelimeter Delimeter { get; set; } = CsvDelimeter.Semikolon;
    ...
    {
        return Delimeter switch
        {
            CsvDelimeter.Comma => ',',
            CsvDelimeter.Semikolon => ';',
            _ => ';'
        };
    }
}
