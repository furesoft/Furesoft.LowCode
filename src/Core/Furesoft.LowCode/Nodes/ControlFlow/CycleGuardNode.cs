...
public class CycleGuardNode : InputOutputNode
{
    private int _maxIterations;

    public CycleGuardNode() : base("Cycle Guard")
    {
    }
    ...
    public int MaxIterations
    {
        ...
        set
        {
            SetProperty(ref _maxIterations, value);

            Description = $"Breaks lop after {value} iterations";
        }
    }
